...
public class Color {
    ...
    /**
     * calc average color of the recurcive
     * @param color
     * @return
     */
    public boolean equal(Color color){
        double red=this._r-color._r;
        double blue=this._b-color._b;
        double green=this._g-color._g;
        if(red<1&&red>-1&&blue<1&&blue>-1&&green<1&&green>-1)return  true;
        else
            return  false;
    }
